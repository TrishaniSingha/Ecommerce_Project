...
public class ProductDaoImpl implements ProductDao 
{
	...
	public List<Product> getAllProducts() 
	{
		...
		//HQL - from Product
		//SQL - select * from product_s190032
	...
	public Product getProduct(int id)
	{
		...
		//id=1,2,3...
		//Select * from Product_S190032 where id=?
		return product;
	}
	//linked with interface ProductDao
	public void deleteProduct(int id)
	{
		...
		//delete from Product_S190032 where id=?
	...
	public void saveOrUpdateProduct(Product product) 
	{
		...
		session.saveOrUpdate(product); //insert into Product_S190032 values(?,..,...,...), id will be generated automatically
		//in the console, insert into product_s190032 (id, price, productdescription, productname, quantity) values (null, ?, ?, ?, ?)
