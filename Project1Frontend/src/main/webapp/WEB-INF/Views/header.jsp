...
<nav class="navbar navbar-default" id="nav_bar">
	...
	data-toggle="collapse" data-target="#collapse-example" aria-expanded="false">
		...
		<img src='<c:url value="/Resources/Images/boutique-en-ligne-illustration-vecteur-ecommerce-illusustration_1085-847.jpg"></c:url>' alt="NIIT"  width="100px" height="60px"></a>
		</div>
					...
					<li class="dropdown">
						...
						<!-- Request Parameter, parameter name is in searchCondition -->
							<li>
								...
								<a href='<c:url value="/all/searchbycategory?searchCondition=womanswear"></c:url>'>womanswear</a>
								<a href='<c:url value="/all/searchbycategory?searchCondition=Electronics"></c:url>'>Electronics</a>
								<a href='<c:url value="/all/searchbycategory?searchCondition=KitchenEssential"></c:url>'>KitchenEssential</a>
								<a href='<c:url value="/all/searchbycategory?searchCondition=Menswear"></c:url>'>Menswear</a>
								<a href='<c:url value="/all/searchbycategory?searchCondition=Medicine"></c:url>'>Medicine</a>
